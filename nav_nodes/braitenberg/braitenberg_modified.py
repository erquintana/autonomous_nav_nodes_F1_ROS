...
TURN_STEERING_ANGLE =   0.220  
n = 6

class Braitenberg(object):
    def __init__(self):
        self.dir = ""
        # Publishers:
    ...
    def scan_callback(self, scan_msg):
        ...
        scan_measures = scan_msg.ranges                                    # 10º each, zones to split scan measurements
...
if __name__ == '__main__':
    rospy.init_node('braitenberg_modified_node')
    f1tenth_CERLab_agent = Braitenberg()
    rospy.spin()
